export default function LightThemeIcon({ className }: { className?: string }) {
  return (
    <svg className={className} fill="currentColor" width="26px" height="26px" viewBox="0 0 32 32" id="icon" xmlns="http://www.w3.org/2000/svg">
